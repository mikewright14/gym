        ...
        <div class="timeline-block">
                 ...
                 <div class="timeline-block">
                    ...
                    <div class="panel panel-default event">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item"><i class="fa fa-globe"></i> Max Bench Press: {{ $users['UserStat']['weight'] }} </li>
                            <li class="list-group-item"><i class="fa fa-globe"></i> Reps Bench Press: {{ $users['UserStat']['weight'] }} </li>
                            <li class="list-group-item"><i class="fa fa-calendar-o"></i>Max Squat:  {{ $users['UserStat']['height'] }} </li>
                            <li class="list-group-item"><i class="fa fa-calendar-o"></i>Reps Squat:  {{ $users['UserStat']['height'] }} </li>
                            <li class="list-group-item"><i class="fa fa-clock-o"></i> Max Deadlift:  {{ $users['UserStat']['age'] }} </li>
                            <li class="list-group-item"><i class="fa fa-clock-o"></i> Reps Deadlift:  {{ $users['UserStat']['age'] }} </li>
                            <li class="list-group-item"><i class="fa fa-clock-o"></i> Max Overhead Press:  {{ $users['UserStat']['sex'] }} </li>
                            <li class="list-group-item"><i class="fa fa-users"></i> Reps Overhead Press:  {{ $activityLevel }}
                            <a href="#" class="btn btn-primary btn-xs pull-right">Change</a>
                            </li>
                        </ul>
                ...
                <div class="timeline-block">
                    <div class="panel panel-default event">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><i class="fa fa-clock-o"></i> Total calories burnt from running:  {{ $users['UserStat']['age'] }} 
                            <a href="#" class="btn btn-primary btn-xs pull-right">Change</a>
                            </li>
                        </ul>
