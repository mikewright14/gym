                ...
                <div id="recent" class="tab-pane active">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table v-middle">
                           ...
                           ?>
                           <?php $foodID = $recent->foodID; ?>

                            <tr>

                                <td>
                                	
                                    {{ Form::checkbox('foodID['.$foodID.']', $recent->foodID) }}
                                ...
                                <td>
                                    {{ Form::text('foodWeight['.$foodID.']', Input::old('foodAmount'), array('placeholder' => 'Per 100 Grams', 'class' => 'form-control')) }}</td>
